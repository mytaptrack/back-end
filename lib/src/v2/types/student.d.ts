import { Milestone, MttTag, AbcCollection, MeasurementType, StudentDocument, StudentDashboardSettings, ScheduleItemType, CalculatedServiceStat, QLServiceGoal } from '@mytaptrack/types';
...
export interface ServiceStorage {
    ...
    weeklyServiceSummary: {
        [epochSec: number]: ServiceWeeklySummary;
    };
    provided: number;
    projected: number;
    excluded: number;
