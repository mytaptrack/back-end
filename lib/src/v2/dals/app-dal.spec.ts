...
describe('AppDal', () => {
    ...
    test.skip('getAppsForLicense', async () => {
    ...
    test.skip('resolveTokens2', async () => {
    ...
    test.skip('convertDeviceId-New', async () => {
